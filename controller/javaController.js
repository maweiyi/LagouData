...
exports.getCity = function (req, res, next) {
    ...
    Job.java.aggregate([{$group: {_id: "$positionName", total: {$sum: 1}}}], function (err, result) {
        //console.log(result);
...
exports.getSalary = function (req, res, next) {
    Job.java.find({}, {"salary":1, "_id":0}, function (err, result) {
        var salaryArr = [];
        var salaryResult = [];
        var salaryValue = [];
        result.map(function (value) {
...
exports.getWorkYear = function (req, res, next) {
    ...
    var workDict = {};
    Job.java.aggregate([{$group: {_id: "$workYear", total: {$sum: 1}}}], function (err, result) {
        result.map(function (value) {
            var workArr = [];
            for (var i in value) {
...
exports.getEducation = function (req, res, next) {
    var eduDict = {};
    Job.java.aggregate([{$group: {_id: "$education", total: {$sum: 1}}}], function (err, result) {
        result.map(function (value) {
            var eduArr = [];
            for (var i in value) {
                eduArr.push(value[i]);
...
exports.getJobNature = function (req, res, next) {
    var jobDict = {};
    Job.java.aggregate([{$group: {_id: "$jobNature", total: {$sum: 1}}}], function (err, result) {
        result.map(function (value) {
            var jobArr = [];
            for (var i in value) {
                jobArr.push(value[i]);
